...
// объявление и инициализация глобального динамического массива типа структура
// Person
...
void task1()
{
	...
	// инициализация первым способом
	// struct Person person = { "Alex", "Potapov", 12, 15.4, 120.5 };

	// объявление одиночной переменной типа структура Person 
	// struct Person person;

	// инициализвация вторым способом
	/*person.age = 23;
	...
	// объявление статического массива типа структур Person
	...
	*/
	...
	// объявление и инициализация локального динамического массива типа структура
