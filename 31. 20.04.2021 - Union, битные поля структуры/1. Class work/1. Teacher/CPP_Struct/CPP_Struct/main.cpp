...
void main()
{
	...
	{
		currentSize = EnterPerson(people, currentSize, MaxPeopleCount);
	}
	
	PrintPeople(people, currentSize);
	...
	cout << cl.color << endl;
	cout << (int)cl.components[0] << endl;
	cout << (int)cl.components[1] << endl;
	cout << (int)cl.components[2] << endl;
	cout << (int)cl.components[3] << endl;

	int color = 0xFFEA0936;
	void* p = &color;

	unsigned char* components = (unsigned char*)p;
	cout << (int)components[0] << endl;
	cout << (int)components[1] << endl;
	cout << (int)components[2] << endl;
	cout << (int)components[3] << endl;*/
