...
void main()
{
	...
	*/
	...
	// Пользователь вводит число, программа определяет, является ли оно простым
	...
	// Пользователь вводит 5 чисел, программа находит количество простых чисел
	/*int count = 0;
	...
	for (int k = 0; k < 5; k++)
	{
		...
		// ввод переменной для определения простоты
		cin >> n;
	...
	// Пользователь вводит числа, пока не введёт 0, программа находит количество
	// и сумму простых чисел(while, do..while, for, for + break)
	...
	cout << "Prime numbers: " << count << ", Sum: " << sum << endl;*/
	...
	// Пользователь вводит числа, пока не введёт 0, программа находит максимальное
	// отрицательное число и выводит его на экран(while, do..while, for, for + break)
	/*int max = 0;
	int n;
	...
	// пользователь вводит числа, пока не введёт 0, программа подсчитывает количество,
	// сумму и произведение нечётных чисел (использовать continue)
	/*int a;
	...
	// оператор switch
	// подсчёт троек, пятёрок, семёрок и других чисел
	...
	cout << "n5 = " << n5 << endl;
	cout << "n7 = " << n7 << endl;
	cout << "outher numbers = " << others << endl;*/

	// пользователь вводит числа, пока не введёт 0, программа подсчитывает количество и сумму
	// чётных, нечётных чисел и чисел, которые без остатка делятся на 3
	int a;
	int even = 0, odd = 0, n3 = 0;
	do
	{
		cin >> a;
